            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className=" space-y-4">
                    <div className="font-inter space-y-2">
                        <h1 className="font-[700] text-xl sm:text-xl md:text-2xl lg:text-[28px]">Optimizing for Speed and Responsiveness</h1>
                ...
                <div className="flex justify-center sm:justify-center md:justify-end ">
                    <img className="w-full max-w-xs md:max-w-md lg:max-w-lg " src="./Blogimg/Page_1/9 1.png" alt="" />
                </div>
            </div>


            {/* left part */}
            <div className="mt-12 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-12">

                <div className="bg-[#D7EAFF] w-full md:w-1/2 lg:w-1/3 rounded-lg p-4 space-y-4">
